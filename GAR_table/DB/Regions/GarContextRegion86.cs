...
public partial class GarContextRegion86 : DbContext, IGarContextRegion
{
    public GarContextRegion86()
    {
    }

    public GarContextRegion86(DbContextOptions<GarContextRegion86> options)
        : base(options)
    {
    }
...
//        => optionsBuilder.UseNpgsql("Host=localhost;Port=5432;Database=GAR;Username=postgres;Password=123");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<AddrObjParam>(entity =>
        {
            ...
            entity.ToTable("ADDR_OBJ_PARAMS", "_86");
        ...
        modelBuilder.Entity<AdmHierarchy>(entity =>
        {
            ...
            entity.ToTable("ADM_HIERARCHY", "_86");
