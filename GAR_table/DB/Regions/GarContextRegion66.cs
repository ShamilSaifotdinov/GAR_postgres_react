...
public partial class GarContextRegion66 : DbContext, IGarContextRegion
{
    public GarContextRegion66()
    {
    }

    public GarContextRegion66(DbContextOptions<GarContextRegion66> options)
        : base(options)
    {
    }
...
//        => optionsBuilder.UseNpgsql("Host=localhost;Port=5432;Database=GAR;Username=postgres;Password=123");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<AddrObjParam>(entity =>
        {
            ...
            entity.ToTable("ADDR_OBJ_PARAMS", "_66");
        ...
        modelBuilder.Entity<AdmHierarchy>(entity =>
        {
            ...
            entity.ToTable("ADM_HIERARCHY", "_66");
