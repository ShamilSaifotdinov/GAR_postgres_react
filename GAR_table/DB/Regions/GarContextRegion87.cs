...
public partial class GarContextRegion87 : DbContext, IGarContextRegion
{
    public GarContextRegion87()
    {
    }

    public GarContextRegion87(DbContextOptions<GarContextRegion87> options)
        : base(options)
    {
    }
...
//        => optionsBuilder.UseNpgsql("Host=localhost;Port=5432;Database=GAR;Username=postgres;Password=123");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<AddrObjParam>(entity =>
        {
            ...
            entity.ToTable("ADDR_OBJ_PARAMS", "_87");
        ...
        modelBuilder.Entity<AdmHierarchy>(entity =>
        {
            ...
            entity.ToTable("ADM_HIERARCHY", "_87");
